...
import { qwenOfficialIndexUrl } from "./official-news-index.js";
import type {
  AiProviderConfig,
  AiSettings,
  ArticleSkillConfig,
...
const configuredDefaultSources: SourceConfig[] = [
  ...
  },
  {
    ...
    routes: [{
      topicId: "ai",
      label: "Claude Platform release feed",
      homepageUrl: "https://platform.claude.com/docs/en/release-notes/overview",
    ...
    role: "official",
    discoveryOnly: false,
    note: "一级信源 · 官方发布日志订阅保留原始日期，官网目录与新闻索引补充发现",
  },
  {
  ...
  },
  {
    ...
    routes: [
      ...
      {
        topicId: "ai",
        label: "Gemini product discovery",
        homepageUrl: "https://blog.google/products-and-platforms/products/gemini/",
  ...
  },
  {
    ...
    role: "verification",
    discoveryOnly: false,
    note: "精选作者试用 · 独立开发者的 AI 实测与解读；个人经验保留原作者署名",
  },
  {
    id: "bens-bites",
    name: "Ben’s Bites",
    kind: "rss",
    homepageUrl: "https://www.bensbites.com/",
    ...
    role: "discovery",
    discoveryOnly: true,
    note: "精选订阅试用 · 用于发现选题与解读，发布事实回到原始公告核对",
  },
  {
  ...
  },
  {
    ...
    name: "通义千问 Qwen 官方",
    kind: "rss",
    homepageUrl: "https://qwen.ai/research",
    topicIds: ["ai"],
    routes: [{
      topicId: "ai",
      label: "Qwen official article index",
      homepageUrl: "https://qwen.ai/research",
      url: qwenOfficialIndexUrl,
      format: "qwen-json",
      category: "ai-official",
    }, {
      topicId: "ai",
    ...
    role: "official",
    discoveryOnly: false,
    note: "一级信源 · 官网文章目录直读，新闻索引用于补漏；保留原始发布日期",
  },
  {
